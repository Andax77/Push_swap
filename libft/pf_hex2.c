...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/12 12:00:11 by anhuang           #+#    #+#             */
/*   Updated: 2018/02/12 12:00:11 by anhuang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void			pf_type_hex5(unsigned long long *nbr, t_params para)
{
	if (para.type == 'h')
...
static void		pf_puhex2(unsigned long nbr, t_params *pa)
{
	int	lol;
	...
	|| (pa->flag.zero && pa->width > 0)))
		pf_puhex2(nbr / (unsigned int)pa->flag.base, pa);
	else
	{
...
void			pf_hex2(va_list p, t_params pa)
{
