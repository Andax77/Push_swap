...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/15 14:56:01 by anhuang           #+#    #+#             */
/*   Updated: 2018/02/15 14:56:02 by anhuang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void		pf_type_hex2(long long *nbr, t_params para)
{
	if (para.type == 'h')
...
static void	pf_big_puhex(long nbr, t_params *pa)
{
	int lol;
	...
	|| (pa->flag.zero && pa->width > 0)))
		pf_big_puhex(nbr / (unsigned int)pa->flag.base, pa);
	else
	{
